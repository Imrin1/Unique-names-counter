...
class TestUniqueNameCounter(unittest.TestCase):
    ...
    def test_AllEqual(self):
        ...
        self.assertEqual(countUniqueNames("Aaron","Rodriguez","Aaron","Rodriguez","Aaron Rodriguez"), 1)
    ...
    def test_withTypo(self):
        ...
        self.assertEqual(countUniqueNames("Aaron","Rodriguez","Aaron","Rokriguez","Dave Smith"), 2)
        self.assertEqual(countUniqueNames("Aaron","Rodriguez","Aapon","Rodriguez","Aarok Rodriguez"), 1)

    def test_threeDifferentNames(self):
        self.assertEqual(countUniqueNames("Aaron","Rodriguez","Lidia","Thomas","Debbie Egli"), 3)
